        ...
        <div className="ml-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {articles.map((article, index) => (
              <div
                key={index}
                className={`relative rounded-[32px] sm:rounded-[48px] overflow-hidden shadow-2xl transition-all duration-500 hover:scale-[1.02] min-h-[500px] flex flex-col justify-end p-10 sm:p-14 ${article.featured
                    ? "bg-black"
