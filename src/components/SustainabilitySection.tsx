    ...
    <section id="sustainability" className="py-24 sm:py-32 bg-black px-6 sm:px-12 lg:px-20 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start items-center h-[350px] sm:h-[450px] lg:h-[500px] mt-12 lg:mt-0">
      ...
      <div className="absolute top-0 inset-x-0 h-[0.5px] bg-[#F8F9FA33]" />
      <div className="absolute bottom-0 inset-x-0 h-[0.5px] bg-[#F8F9FA33]" />
    </section>
  );
}
